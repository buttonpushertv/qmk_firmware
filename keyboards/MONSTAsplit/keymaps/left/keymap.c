...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_LOWER] = LAYOUT(
      ...
      KC_BTN1,                  KC_BTN2,                  KC_BTN3,                  KC_NO,                    KC_MUTE,                  _______,                    _______, _______, _______, _______, _______, _______, _______,
      KC_BTN4,                  KC_BTN5,                  KC_NO,                    KC_NO,                    KC_VOLU,                  _______,                    _______, _______, _______, KC_CALC, _______, _______, _______,
      KC_NO,                    KC_NO,                    _______,                  KC_NO,                    KC_VOLD,                  _______,                    _______, _______, _______, _______, _______, _______, _______
    ),
    /* Raise
    * +--------------------------------------------------------------------------------------------------------------------+
    ...
    */
    [_RAISE] = LAYOUT(
      ...
      RESET,   _______, _______, BL_STEP, BL_DEC,  BL_TOGG, _______, _______, _______, _______,  _______, KC_BSPC, _______
    )
};
